...
* The https://github.com/belgif/rest-problem-java[rest-problem-java] library can be used to implement error handling in Java REST clients and server implementations, using <<chapter-error-handling,standardized Problem messages>>.
