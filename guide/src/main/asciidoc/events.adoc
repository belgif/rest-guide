...
Future minor version updates of the CloudEvents specification or of the Asynchronous Message schemas may define additional attributes. For forward-compatibility, consumers SHOULD ignore any unknown context attributes.
