...
* _resourceType_ : the type of resource of the subject of the message. The same naming and resource hierarchy should be used consistently across REST APIs (see xref:resources-document.adoc#Document[]) and asynchronous messages. This means lowerCamelCase and plural for resources part of a collection and singular for singleton resources.
