...
|Accept       | Request  | Media type(s) that is(/are) acceptable for the response. | <<Media Types>>, status code <<http-406,406>>
|Content-Type	| Request/Response | The Media type of the body of the request. | <<Media Types>>, status code <<http-415,415>>
