...
As JSON Merge Patch requests can not be fully specified as a JSON Schema type, a MergePatch marker type should be used, defined in link:schemas/common/v1/common-v1.yaml[common-v1.yaml].
