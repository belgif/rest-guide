...
As JSON Merge Patch requests can not be fully specified as a JSON Schema type, a MergePatch placeholder type should be used, defined in link:schemas/common/v1/common.yaml[common.yaml].
