...
The value of this parameter SHOULD be in https://en.wikipedia.org/wiki/Backus%E2%80%93Naur_form[BNF notation].
====
...
The BNF notation can also be used for nested properties:
