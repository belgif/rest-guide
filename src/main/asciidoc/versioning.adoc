...
* OpenAPI 3.0 add support for deprecating parameters and Schema Objects (data types)
* OpenAPI 3.1 also allows to specify deprecation everywhere within Schema Objects e.g. on  properties
