...
In order to conform to the REST uniform service contract, REST services should stick to this reduced list of status codes. The addition of new status codes should be evaluated bu the REST policy group.
