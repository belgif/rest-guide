...
A notable exception to this rule is the swagger/OpenAPI file.
====
...
====
When a single query parameter can have multiple value, the parameter should be repeated for each value.
====
