== Changelog
* 2020-09-10
** add new section under <<Collection, Collection>> resources to  <<Remove, Remove items from collection>>
** cleanup of status codes in various locations like <<Collection>>, <<Document>>, <<HTTP Methods>> and <<Status Codes>> 
** add details about status code <<429 Too Many Requests, 429 Too Many Requests>> under section <<HTTP Methods, HTTP Methods>>
** add a table about how to use each method of section <<HTTP Methods, HTTP Methods>>
* 2020-xx-xx
