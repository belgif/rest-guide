...
Unless the API documentation explicitly states otherwise:

* returned items should satisfy ALL filter query parameters,
* items that match ANY of the values of a multi-valued filter query parameter are returned.
====
​
[cols="1,2,3"]
|===
