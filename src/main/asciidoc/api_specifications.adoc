...
The Schema Object follows a variant of the *JSON Schema draft 04* standard, with some significant incompatibilities.
====
...
====
Common definitions for use by Belgian government institutions are published on https://www.gcloud.belgium.be/rest/schemas/ (TODO: this path is not yet navigable).
