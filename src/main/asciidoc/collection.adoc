...
- the API can accept a `~` at the beginning of the string to do approximative search (trigram search, phonetic search, Levenshtein distance, soundex,... the algorythm used must me specified in the documentation)

.Examples of string filtering
====
 ssin=0000000097       (exact search)
 ssin=\d{2}0229\d{5}   (reg ex)
