...
| `_contains`
| text contains
| `ssin_contains=771006`

| `_startsWith`
| text start with
| `ssin_startsWith=771006`
...
|name_contains
|query-param
|Filter only employers that have a name containing the given value.

|name_startsWith
|query-param
|Filter only employers that have a name starting with the given value.

|name_endsWith
|query-param
|Filter only employers that have a name ending with the given value.
