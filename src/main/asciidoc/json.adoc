...
All JSON property names are in English and are written in lower camel case notation. Do not use underscore or hypens for composite words (Properties from the <<hal-links,HAL standard>> are an exception to this rule). 
