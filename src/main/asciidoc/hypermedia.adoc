...
.HttpLink JSON data type (from https://github.com/belgif/openapi-common/blob/master/src/main/swagger-2.0/common/v1/common-v1.yaml[common-v1.yaml])
```YAML
HttpLink:
...
.SelfLink JSON data type (from https://github.com/belgif/openapi-common/blob/master/src/main/swagger-2.0/common/v1/common-v1.yaml[common-v1.yaml])
```YAML
SelfLink:
