...
ifdef::full-guide[]
(see xref:api_specifications.adoc#rule-req-valid[[req-valid\]])
endif::[]
...
ifdef::full-guide[]
This issue type is only used for resource identifiers in header or query parameters or in the request body. For resource identifiers in the request path, a xref:problems/resourceNotFound.adoc[] Problem is returned instead, with a `404` status code.
endif::[]
|===
...

{
  ...
  "issues": [
    ...
    },
    {
      ...
      "href": "{API}/problems/replacedSsin",
    ...
    },
    {
      ...
      "detail": "Person referenced as board member with SSIN '98765432109' does not exist",
      "in": "body",
    ...
    },
    {
      ...
      "href": "link:https://www.belgif.be/specification/rest/api-guide/issues/invalidInput.html[]",
      "title": "Invalid input",
