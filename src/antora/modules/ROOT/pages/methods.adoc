...
== POST
*POST should be used to xref:resources-collection.adoc#create-resource[create a new resource] in a collection, to execute a xref:resources-controller.adoc#Controller[controller] resource or as alternative for operations with xref:resources.adoc#rule-sens-date[sensitive input data].*
...
|xref:resources-collection.adoc#collections-consult[ consult]
