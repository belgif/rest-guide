...
== POST
*POST must be used to xref:resources-collection.adoc#create-resource[create a new resource] in a collection or to execute a xref:resources-controller.adoc#Controller[controller] resource.*
...
See xref:resources-document.adoc#partial-update[Partial update] on how to specify the set of instructions describing how a resource on the server should be modified.
