...
1.  a suitable xref:statuscodes.adoc#status-codes[status code]: 4xx for consumer or 5xx for server errors
2.  a RFC 9457 problem detail message

[rule#rule-err-problem]
...
* `detail`: consumer-friendly information about the specific failing request. It MAY be localized using xref:internationalization.adoc#i18n-negotiation[ language negotiation].
...
* `type` and `instance` SHOULD be specified as absolute URIs in order to avoid issues when resolving relative URIs (see xref:links.adoc#links[Links])
...
====
```
POST /enterprises/abcd731645/employees
{
  "ssin": "98765432109",
  "givenName": "John",
  "familyName": "Doe"
  ...
  "issues": [
    {
      ...
      "detail": "enterpriseNumber abcd731645 should be numeric",
      "in": "path",
    ...
    },
    {
      ...
      "href": "link:https://www.belgif.be/specification/rest/api-guide/issues/referencedResourceNotFound.html[]",
      "title": "Referenced resource not found",
      "detail": "No person with ssin '98765432109' exists",
      "in": "body",
      "name": "/ssin",
      "value": "98765432109"
    }
...
----
{
  "type": "urn:problem-type:exampleOrg:socialStatus:searchCriteriaTooWide",
  "href": "{API}.be/socialStatus/v2/refData/problemTypes/urn:problem-type:exampleOrg:socialStatus:searchCriteriaTooWide",
  "status": 400,
...
The standardized problem types are described in their individual pages in the annex:

[cols="1,3"]
|===
| Status code | Problem type

| 400 | xref:problems/badRequest.adoc[`urn:problem-type:belgif:badRequest`]
| 401 | xref:problems/noAccessToken.adoc[`urn:problem-type:belgif:noAccessToken`]
| 401 | xref:problems/invalidAccessToken.adoc[`urn:problem-type:belgif:invalidAccessToken`]
| 401 | xref:problems/expiredAccessToken.adoc[`urn:problem-type:belgif:expiredAccessToken`]
| 403 | xref:problems/missingScope.adoc[`urn:problem-type:belgif:missingScope`]
| 403 | xref:problems/missingPermission.adoc[`urn:problem-type:belgif:missingPermission`]
| 404 | xref:problems/resourceNotFound.adoc[`urn:problem-type:belgif:resourceNotFound`]
| 413 | xref:problems/payloadTooLarge.adoc[`urn:problem-type:belgif:payloadTooLarge`]
| 429 | xref:problems/tooManyRequests.adoc[`urn:problem-type:belgif:tooManyRequests`]
| 429 | xref:problems/tooManyFailedRequests.adoc[`urn:problem-type:belgif:tooManyFailedRequests`]
| 500 | xref:problems/internalServerError.adoc[`urn:problem-type:belgif:internalServerError`]
| 502 | xref:problems/badGateway.adoc[`urn:problem-type:belgif:badGateway`]
| 503 | xref:problems/serviceUnavailable.adoc[`urn:problem-type:belgif:serviceUnavailable`]
|===

link:https://github.com/belgif/openapi-problem/blob/master/src/main/openapi/problem/v1/problem-v1.yaml[problem-v1.yaml] provides a reusable `InputValidationProblem` schema that extends the `Problem` schema with a list of issues for use in xref:problems/badRequest.adoc[`badRequest`] and xref:problems/resourceNotFound.adoc[`resourceNotFound`] problems. Following standard issue types are defined for `badRequest`:

|===
| Issue type

|xref:issues/schemaViolation.adoc[`urn:problem-type:belgif:input-validation:schemaViolation`]
|xref:issues/invalidInput.adoc[`urn:problem-type:belgif:input-validation:invalidInput`]
|xref:issues/unknownInput.adoc[`urn:problem-type:belgif:input-validation:unknownInput`]
|xref:issues/referencedResourceNotFound.adoc[`urn:problem-type:belgif:input-validation:referencedResourceNotFound`]
|===