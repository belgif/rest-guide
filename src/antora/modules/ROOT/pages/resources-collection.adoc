...
====
A collection may support xref:reserved.adoc#query-parameters[query parameters] to retrieve filter its items:
...
| `total` | OPTIONAL | Total number of items across all pages. If filter parameters are used, this is the total of the result set, not of the entire collection.
|===
