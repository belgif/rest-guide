...
.Collection name
====
{API}/employers[b] - a collection of employers

{API}/employers/+{employerId}+/subsidiaries[^] - a collection of subsidiaries as a child resource of an employer.
====
...
.Consultation with complex input structure
====

If input with a complex structure is needed, a `/search` controller with `POST` may be used.
