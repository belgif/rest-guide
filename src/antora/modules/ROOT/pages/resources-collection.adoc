...
In this case, the full representations MUST be included in an 'embedded' property as described in xref:performance.adoc#embedding-resources[Embedding resources].
====
