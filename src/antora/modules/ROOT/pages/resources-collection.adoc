...
When consultation requires input parameters with a complex structure (e.g. extensive search or sorting parameters), a `POST` operation on a `/search` controller MAY be used instead of `GET`. This allows to represent the input parameters in a structured manner in a JSON request body without the limitations of query parameters.
...
|name
|query-param
|Only match employers that have a specific name.
...
----
{
  "self": "{API}/enterprises?name=belg[/enterprises?name=belg^]",
	"items": [{
		"href": "{API}/enterprises/0202239951[/enterprises/0202239951^]",
		"title": "Belgacom"
	}, {
		"href": "{API}/enterprises/0448826918[/enterprises/0448826918^]",
...
[subs=normal]
```
GET {API}/enterprises?name=belg[^] HTTP/1.1
```
...
[subs="normal"]
```
GET {API}/enterprises?page=2&pageSize=2[^] HTTP/1.1
```

[source,json, subs="normal"]
----
{
  "self": "{API}/enterprises?page=2&pageSize=2[/enterprises?page=2&pageSize=2^]",
  "items": [
    {
      "href": "{API}/enterprises/202239951[/enterprises/202239951^]",
      "title": "Belgacom"
    },
    {
      "href": "{API}/enterprises/212165526[/enterprises/212165526^]",
      "title": "CPAS de Silly"
    }
  ],
  "pageSize": 2,
  "page": 2,
  "total": 7,
  "first": "{API}/enterprises?pageSize=2[/enterprises?pageSize=2^]",
  "last": "{API}/enterprises?page=4&pageSize=2[/enterprises?page=4&pageSize=2^]",
  "prev": "{API}/enterprises?page=1&pageSize=2[/enterprises?page=1&pageSize=2^]",
  "next": "{API}/enterprises?page=3&pageSize=2[/enterprises?page=3&pageSize=2^]"
}
----
====
...
[subs="normal"]
```
GET {API}/enterprises?afterEnterprise=0244640631[^] HTTP/1.1
```

[source,json, subs="normal"]
----
{
  "self": "{API}/enterprises?afterEnterprise=0244640631&pageSize=2[/enterprises?afterEnterprise=0244640631&pageSize=2^]",
  "items": [
    {
      "href": "{API}/enterprises/0202239951[/enterprises/0202239951^]",
      "title": "Belgacom"
    ...
    {
      "href": "{API}/enterprises/0212165526[/enterprises/0212165526^]",
      "title": "CPAS de Silly"
    }
  ],
  "pageSize": 2,
  "total": 7,
  "first": "{API}/enterprises?pageSize=2[/enterprises?pageSize=2^]",
  "next": "{API}/enterprises?afterEnterprise=0212165526&pageSize=2[/enterprises?afterEnterprise=0212165526&pageSize=2^]"
}
----
====
