...
. xref:http.adoc#media-types[Hypermedia] – What type of data is being transferred?
...
. *xref:hypermedia.adoc[]* -- Level 3 introduces discoverability, providing a way of making a protocol more self-documenting.
