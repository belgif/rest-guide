...
----
{
  ...
  "href": "link:https://www.belgif.be/specification/rest/api-guide/issues/ext/equalExpected.html[]",
  "title": "These inputs must be equal",
  "detail": "These inputs must be equal: meetingId, id",
  "inputs": [ <1>
    {
      "in": "path",
      "name": "meetingId",
