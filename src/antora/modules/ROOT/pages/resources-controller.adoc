...
xref:resources-document.adoc#long-running-tasks[Long-running tasks] are an example of actions modelled as a collection/document instead of a controller.
