...
A document resource is a _singular concept_ that is referring to a business entity or object instance. A document’s state representation typically includes both _fields with values_ and xref:links.adoc#links[_links_] to other related resources.
...
In that case, model the related resources in a separate API and link to the principal resource not by including a link (URL) across APIs (see xref:links.adoc#rule-hyp-links[[hyp-links\]]) but just by adding the <<section-identifier, identifier>> of the principal resource in the representation.
...
----
{
  ...
  "deliveryMethod": {
     ...
     "href": "{API}/refData/deliveryMethods/deliveredAtHome"
  }
}
----
...
----
{
  ...
  "enterprise": {
    ...
    "href": "{API}/enterprises/0202239951"
  }
}
----
...
----
{
  ...
  "href": "link:https://www.belgif.be/specification/rest/api-guide/problems/badRequest.html[]",
  "status": 400,
  "title": "Bad Request",
  ...
  "issues": [
    {
      ...
      "href": "link:https://www.belgif.be/specification/rest/api-guide/issues/schemaViolation.html[]",
      "in": "path",
      "name": "employerId",
      "value": "abc",
...
----
{
  "self": "{API}/employers/93017373?select=(name)",
  "name": "Proximus"
}
----
