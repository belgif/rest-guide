...
Restrictions on `additionalProperties`, other than when used for maps, SHOULD be avoided, in order to support API evolution (xref:versioning.adoc#rule-evo-object[[evo-object\]]).
====
