...
Other uses of `additionalProperties` (e.g. `additionalProperties: false`) SHOULD be avoided, in order to support API evolution (xref:versioning.adoc#rule-evo-object[[evo-object\]]).
====
