...
```json
{
   "self": "{API}/enterprises/0202239951[/enterprises/0202239951^]"
   "owner": {
      "ssin": "12345678901",
      "href": "http://example.org/v1/persons/12345678901"
   },
   "website": "https://wwww.myenterprise.com"
}
```

PATCH {API}/enterprises/1
...
```json
{
   "self": "{API}/enterprises?page=2&pageSize=10[/enterprises?page=2&pageSize=10^]",
   "prev": "{API}/enterprises?page=2&pageSize=1[/enterprises?page=1&pageSize=10^]",
   "next": "{API}/enterprises?page=2&pageSize=3[/enterprises?page=3&pageSize=10^]"
}
```
====
