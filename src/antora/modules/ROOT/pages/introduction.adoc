...
_Last update of this guide on: {rest-guide-update-date}_
...
* The https://github.com/belgif/rest-problem-java[belgif-rest-problem-java] library can be used to implement error handling in Java REST clients and server implementations, using xref:errorhandling.adoc#error-handling[standardized Problem messages].
...
| link:https://www.nisse.be[image:logos/nisse.png[National Institute for the Social Security of the Self-employed,title=National Institute for the Social Security of the Self-employed],window=_blank]
...
Third-party components included in the generated site are listed in xref:third-party-notices.adoc[Third-party Notices].
