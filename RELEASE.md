...
This triggers a new GitHub Actions build (`npm-release` workflow) using the tag as version number and creates a draft release with the `rest-styleguide-<version>.zip` artifact attached.
